...
@CommandManager.add_command("/bot restart",
...
@CommandManager.add_command("/bot status",
...
@CommandManager.add_command("/whitelist add",
...
@CommandManager.add_command("/whitelist remove",
