...
@CommandManager.add_command("/serverlist",
...
@CommandManager.add_command("/serverlist add",
...
@CommandManager.add_command("/serverlist del",
...
@CommandManager.add_command("/serverlist enable",
...
@CommandManager.add_command("/serverlist disable",
...
@CommandManager.add_command("/serverlist rename",
...
@CommandManager.add_command("/serverlist weight",
...
@CommandManager.add_command("/serverlist reload",
...
@CommandManager.add_command("/serverlist list",
